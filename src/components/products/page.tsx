            ...
            data.map((data: any, index: any) => {
              return (
                <div
                  ...
                  } relative overflow-hidden bg-white border border-gray-200 rounded-xl group`}
                >
                  ...
                  <div className="relative">
                    <div className="aspect-w-1 aspect-h-1">
                      <img
                        className="object-cover w-full h-72 p-4"
                        src={data.store?.previewImageUrl}
                        alt=""
                      />
                    </div>
                    ...
                    <div className="px-6 py-4">
                      ...
                      <p className="mt-5 text-sm font-bold text-gray-900">
                        Rs {data.store?.priceRange.maxVariantPrice}
                      </p>
                    </div>
                  </div>
          ...
          {/* <div className="relative overflow-hidden bg-white border border-gray-200 rounded-xl group">
            ...
            <div className="relative">
              ...
              <div className="px-6 py-4">
                ...
                <p className="mt-5 text-sm font-bold text-gray-900">$7.49</p>
              </div>
            </div>
            <div className="absolute inset-x-0 bottom-0 transition-all duration-200 translate-y-full group-hover:translate-y-0">
              <button
          ...
          <div className="relative overflow-hidden bg-white border border-gray-200 rounded-xl group">
            ...
            <div className="relative">
              ...
              <div className="px-6 py-4">
                ...
                <p className="mt-5 text-sm font-bold text-gray-900">$11.99</p>
              </div>
            </div>
            <div className="absolute inset-x-0 bottom-0 transition-all duration-200 translate-y-full group-hover:translate-y-0">
              <button
          ...
          <div className="relative overflow-hidden bg-white border border-gray-200 rounded-xl group">
            ...
            <div className="relative">
              <div className="aspect-w-1 aspect-h-1">
                <img
                  className="object-cover w-full h-full p-4"
                  src="https://cdn.rareblocks.xyz/collection/clarity-ecommerce/images/item-cards/1/product-5.png"
                  alt=""
                />
              </div>
              <div className="px-6 py-4">
                ...
                <p className="mt-5 text-sm font-bold text-gray-900">$19.93</p>
              </div>
            </div>
            <div className="absolute inset-x-0 bottom-0 transition-all duration-200 translate-y-full group-hover:translate-y-0">
              <button
